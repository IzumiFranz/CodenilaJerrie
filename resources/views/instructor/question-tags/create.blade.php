...
@section('title', 'Create Question Tag')
...
<div class="row">
    <div class="col-lg-8 mx-auto">
        ...
        <div class="card shadow">
            <div class="card-body">
                <form method="POST" action="{{ route('instructor.question-tags.store') }}">
                    @csrf
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <div class="input-group-append">
                                <span class="input-group-text" id="colorPreview" style="background-color: {{ old('color', '#007bff') }}; width: 50px;"></span>
                            </div>
                        </div>
                        @error('color')
                            <div class="invalid-feedback">{{ $message }}</div>
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control @error('description') is-invalid @enderror" 
                                  ...
                                  name="description" 
                                  rows="3"
                                  placeholder="Brief description of this tag's purpose">{{ old('description') }}</textarea>
                        @error('description')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror>
                    </div>
                    ...
                    <div class="form-group">
                        <label>Preview:</label>
                        <div>
                            <span id="tagPreview" class="badge" style="background-color: {{ old('color', '#007bff') }}; color: white; font-size: 14px;">
                                <i class="fas fa-tag mr-1"></i><span id="previewText">Your Tag Name</span>
                            </span>
                        </div>
                    </div>
