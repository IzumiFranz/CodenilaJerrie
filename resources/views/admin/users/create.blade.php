                ...
                <form action="{{ route('admin.users.store') }}" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <small class="form-text text-muted">
                            Select the role for this user. Different fields will appear based on the selected role.
                        </small>
                    </div>
                    ...
                    <div id="admin-fields" style="display: none;">
                        <h5 class="mb-3 text-danger">Admin Information</h5>
                    ...
                    <div id="instructor-fields" style="display: none;">
                        <h5 class="mb-3 text-success">Instructor Information</h5>
